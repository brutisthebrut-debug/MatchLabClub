...
import mirrorLearningsRouter from "./mirrorLearnings";
...
import journeyExperimentsRouter from "./journeyExperiments";
import journeyFollowUpsRouter from "./journeyFollowUps";
...
router.use(mirrorLearningsRouter);
...
router.use(journeyExperimentsRouter);
router.use(journeyFollowUpsRouter);
