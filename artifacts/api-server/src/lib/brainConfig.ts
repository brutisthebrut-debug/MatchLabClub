...
export const CONNECTOR_CATALOG: readonly ConnectorCatalogEntry[] = [
  ...
  { id: "spotify", title: "Spotify", status: "live" },
  { id: "strava", title: "Strava rhythm", status: "live" },
  { id: "fitbit", title: "Fitbit activity", status: "live" },
  { id: "exist", title: "Exist life-log", status: "live" },
  { id: "oura", title: "Oura", status: "live" },
  { id: "trakt", title: "Trakt", status: "live" },
  { id: "github", title: "GitHub", status: "live" },
  { id: "reddit", title: "Reddit", status: "live" },
  { id: "discord", title: "Discord", status: "live" },
