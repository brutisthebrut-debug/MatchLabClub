  ...
  return (
    <div className="mx-auto flex max-w-md flex-col items-center gap-4 px-6 py-24 text-center">
      ...
      <p className="text-muted-foreground">
        ...
        choose to share, makes grounded observations, and holds you to what you
        say you will do. It says what it knows, what it does not, and challenges
        you without being cruel. Sign in to meet yours.
      </p>
      <button
        type="button"
        onClick={onSignIn}
      ...
      <div className="mx-auto w-full max-w-5xl px-4 py-8 sm:px-6">
        <header className="mb-8">
          ...
          <p className="mt-2 max-w-2xl text-muted-foreground">
            One companion who travels every page with you, learns from what you
            choose to share, and stays honest about what it knows.
          </p>
        </header>
              ...
              <div className="mt-3 space-y-3">
                {turns.length === 0 && (
                  <p className="text-sm text-muted-foreground">
                    ...
                    knows about you and says when its confidence is low.
                  </p>
                )}
                {turns.map((t, i) => (
                  <div
