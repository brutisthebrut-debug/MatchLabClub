...
export default function Quizzes() {
  ...
  Short, honest quizzes that name the pattern beneath your dating, and quietly map to your <Link href="/wellness" className="text-[hsl(248_62%_62%)] underline-offset-2 hover:underline">wellness profile</Link> so
