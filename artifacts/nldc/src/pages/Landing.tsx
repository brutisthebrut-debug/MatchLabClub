  ...
  return (
    <div className="glass-elevated rounded-[2rem] border border-[hsl(248_62%_52%/0.3)] p-7 md:p-8 shadow-2xl relative overflow-hidden glow-violet">
      ...
      <div className="flex items-center justify-between mb-7 relative z-10">
        ...
        <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground/70 px-2.5 py-1 rounded-full border border-foreground/10">
          live demo
        </span>
      </div>
...
export default function Landing() {
  useMeta(
    "MatchLab Club: an honest companion for your dating life",
    "Meet Echo, the companion that helps you understand yourself, wait honestly, and be ready for one considered introduction when the fit is real.",
  ...
  return (
    <AppLayout>
      ...
      <section className="relative mesh-bg overflow-hidden pt-28 md:pt-32 pb-24 md:pb-36 min-h-[100dvh] flex flex-col justify-center">
        ...
        <div
          ...
          style={{
            ...
            maskImage:
              "radial-gradient(ellipse 85% 60% at 50% 42%, black, transparent 78%)",
            WebkitMaskImage:
              "radial-gradient(ellipse 85% 60% at 50% 42%, black, transparent 78%)",
          }}
        />
          ...
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-10 items-center max-w-7xl mx-auto">
            ...
            <div className="lg:col-span-7 text-center lg:text-left">
              ...
              <motion.p
                ...
                {...fadeUp(0.28)}
              >
                in your corner, from first read to whatever comes next
              </motion.p>
              ...
              <motion.p
                ...
                {...fadeUp(0.34)}
              >
                Every app reduces you to a few photos and a half-second swipe.
                Echo is the friend underneath all of it. It gets to know the
                real you, helps you understand your patterns, and keeps the path
                honest from the first read through a considered introduction.
              </motion.p>
              ...
              >
                <span className="inline-flex items-center gap-2">
                  <Clock className="w-4 h-4 text-[hsl(248_62%_52%)]" /> 3
                  minutes
                </span>
                <span className="w-1.5 h-1.5 rounded-full bg-muted-foreground/30" />
                <span className="inline-flex items-center gap-2">
                  <Shield className="w-4 h-4 text-[hsl(142_55%_50%)]" /> No
                  account required
                </span>
                <span className="w-1.5 h-1.5 rounded-full bg-muted-foreground/30" />
                <span className="inline-flex items-center gap-2">
                  <Lock className="w-4 h-4 text-[hsl(326_100%_59%)]" /> Private
                  by design
                </span>
              </motion.div>
            </div>
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(160deg, #131234 0%, #1d1147 55%, #2a0f3d 100%)",
        }}
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            >
              ...
              to really{" "}
              <span className="italic" style={{ color: "#FF6FC4" }}>
                know you.
              </span>
            </motion.h2>
            <motion.p
              ...
              {...fadeUp(0.2)}
            >
              They are built for quick decisions and more scrolling. Echo flips
              it: it gets to know the real you, helps you see what actually
              fits, and never invents a person who is not there.
            </motion.p>
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto text-left">
              <motion.div
                ...
                {...fadeUp(0.26)}
              >
                <p className="text-xs font-bold uppercase tracking-[0.2em] text-white/55 mb-5">
                  What the apps see
                </p>
                <ul className="space-y-3">
                  {["Six photos", "A one-line bio", "A half-second swipe"].map(
                    (x) => (
                      <li
                        key={x}
                        className="flex items-center gap-3 text-white/65 font-medium text-lg line-through decoration-white/40"
                      >
                        <Eye className="w-5 h-5 flex-shrink-0 text-white/45" />{" "}
                        {x}
                      </li>
                    ),
                  )}
              ...
              <motion.div
                ...
                style={{
                  background:
                    "linear-gradient(160deg, hsl(248 62% 52% / 0.25), hsl(326 100% 59% / 0.15))",
                }}
                {...fadeUp(0.32)}
              >
                <p className="text-xs font-bold uppercase tracking-[0.2em] text-[hsl(326_100%_80%)] mb-5">
                  What Echo pays attention to
                </p>
                <ul className="space-y-3">
                  {[
                    ...
                    >
                      <Zap className="w-5 h-5 flex-shrink-0 text-[hsl(326_100%_75%)]" />{" "}
                      {x}
                    </li>
                  ))}
                </ul>
      ...
      <section className="py-32 border-t border-foreground/5 bg-[hsl(248_40%_98%/0.5)] dark:bg-[hsl(248_50%_8%/0.5)] relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-24 max-w-3xl mx-auto">
            <p className="text-sm font-bold uppercase tracking-widest text-[hsl(248_62%_52%)] mb-4">
              How Echo gets to know you
            </p>
            <h2 className="text-4xl md:text-6xl font-serif font-bold text-foreground leading-tight">
              ...
              <span className="gradient-text italic pr-1">
                the more grounded the next step.
              </span>
            </h2>
            <p className="text-muted-foreground text-xl mt-6 leading-relaxed font-medium">
              Every tool does two things at once. It helps you today, and it
              lets Echo understand you a little better, so any future
              introduction is more considered.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              ...
              },
              {
                step: "03",
                title: "Wait honestly",
                desc: "Profile-ready is not a promise that someone is available. When a real nearby fit exists, Echo can bring one considered introduction forward.",
                color: "hsl(142 55% 50%)",
              },
            ].map((item, i) => (
              <motion.div
              ...
              >
                <div
                  className="absolute -top-4 -right-4 p-8 text-9xl font-serif font-bold opacity-[0.03] group-hover:opacity-[0.06] transition-opacity pointer-events-none"
                ...
                <div
                  ...
                  style={{ background: withAlpha(item.color, 0.1) }}
                >
                  <span
                ...
                <p className="text-lg text-muted-foreground leading-relaxed mb-4 flex-1 relative z-10 font-medium">
                  {item.desc}
                </p>
              </motion.div>
            ))}
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-24 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed font-medium">
              These are the tools Echo uses to help you right now. Each one is
              useful on its own, and each one can sharpen the evidence behind a
              future considered introduction.
            </p>
          </div>
            ...
            {[
              {
                icon: FileText,
                title: "Signal Check",
                desc: "A fast read of your profile with bio and prompt rewrites, plus a Signal Score.",
                href: "/signal-check",
                color: "hsl(var(--brand-indigo))",
              },
              {
                ...
                desc: "Always-on deterministic checklist, plus opt-in vision to read how your photos actually land.",
                href: "/signal-check",
                color: "hsl(326 100% 59%)",
              },
              {
                icon: MessageCircle,
                title: "Message Coach",
                desc: "Paste a conversation and get replies with the reasoning behind each.",
                href: "/coach",
                color: "hsl(190 55% 55%)",
              },
              {
                ...
                desc: "Paste your message history to see communication patterns and your attachment style.",
                href: "/insights",
                color: "hsl(var(--brand-gold))",
              },
              {
                ...
                desc: "A deeper read on who you actually work well with and what you respond to.",
                href: "/compatibility-compass",
                color: "hsl(var(--brand-indigo))",
              },
              {
                icon: LayoutGrid,
                title: "Wingman Studio",
                desc: "Your copilot hub for pre-date prep, flirt coaching, post-date debriefs, and growth plans.",
                href: "/copilot",
                color: "hsl(326 100% 59%)",
              },
              {
                ...
                desc: "Track your scorecard, dating timeline, patterns, experiments, and a dating wins log.",
                href: "/progress/scorecard",
                color: "hsl(285 55% 56%)",
              },
              {
                icon: BookOpen,
                title: "Your Mirror",
                desc: "A private journal and structured post-date notes to spot your own patterns.",
                href: "/your-mirror",
                color: "hsl(248 62% 52%)",
              },
              {
                ...
                desc: "Track the life dimensions that feed your readiness, from sleep to social energy.",
                href: "/wellness",
                color: "hsl(142 55% 50%)",
              },
            ].map((tool, i) => (
              <motion.div key={i} variants={staggerItem}>
                ...
                >
                  <div
                    className="absolute top-0 right-0 w-32 h-32 rounded-bl-full opacity-0 group-hover:opacity-10 transition-opacity"
                  ...
                  <div className="flex items-center gap-5 mb-6 relative z-10">
                    <div
                      ...
                      style={{
                        border: `1px solid ${withAlpha(tool.color, 0.3)}`,
                      }}
                    >
                      <tool.icon
                        className="w-7 h-7"
                    ...
                    <h3 className="text-xl font-bold text-foreground leading-tight group-hover:text-[hsl(248_62%_52%)] transition-colors">
                      {tool.title}
                    </h3>
                  </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid lg:grid-cols-2 gap-20 max-w-7xl mx-auto items-center">
                ...
                {[
                  ...
                  return (
                    ...
                    >
                      <Link
                        href={
                          s.label === "Your Vault" ? "/vault" : "/connections"
                        }
                      ...
                      >
                        <div className="flex justify-between items-start w-full">
                          <div
                            className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 bg-white dark:bg-black/40"
                            style={{
                          ...
                          <span
                            className="inline-flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-wider bg-background/50 px-2 py-1 rounded-full border border-foreground/5"
            ...
            <motion.div {...fadeUp(0.2)} className="order-1 lg:order-2">
              <p className="text-sm font-bold uppercase tracking-widest text-[hsl(var(--brand-gold))] mb-4">
                Connection Center
              </p>
              <h2 className="text-5xl font-serif font-bold text-foreground mb-8 leading-tight">
                Plug in your{" "}
                <span className="gradient-text italic pr-1">real world.</span>
              </h2>
              <div className="space-y-6 text-xl text-muted-foreground leading-relaxed font-medium">
                <p>
                  You generate signals everywhere. We let you pull them together
                  in one private vault.
                </p>
                <p>
                  Every connection is opt-in, consent-first, and clearly states
                  what we see and what we never touch. We do not pretend
                  calendar imports or Instagram pastes are live background
                  syncs. You paste or upload what you want us to read.
                </p>
              </div>
              <div className="mt-12">
                <Link
                  href="/connections"
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full bg-foreground text-background font-bold hover:opacity-90 transition-opacity"
                >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-foreground mb-6">
              The MatchLab Standard
            </h2>
            <p className="text-xl text-muted-foreground font-medium max-w-2xl mx-auto">
              We hold ourselves to a standard that exists nowhere else.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <motion.div
              className="glass-strong rounded-[2rem] p-10 border border-[hsl(142_55%_50%/0.3)] shadow-lg"
              {...fadeUp(0.1)}
            >
              ...
              <p className="text-muted-foreground leading-relaxed font-medium">
                Our deterministic engine runs with no external calls. Deep AI
                via Anthropic is strictly opt-in, zero-retention, never sold,
                and never used for training. Export or delete everything
                anytime.
              </p>
            </motion.div>

            <motion.div
              className="glass-strong rounded-[2rem] p-10 border border-[hsl(248_62%_52%/0.3)] shadow-lg"
              {...fadeUp(0.2)}
            >
              ...
              <p className="text-muted-foreground leading-relaxed font-medium">
                Inclusive by default. All genders, all orientations. The work of
                being seen clearly applies to every kind of connection. We are
                never a niche app.
              </p>
            </motion.div>

            <motion.div
              className="glass-strong rounded-[2rem] p-10 border border-[hsl(326_100%_59%/0.3)] shadow-lg"
              {...fadeUp(0.3)}
            >
      ...
      <section className="py-32 border-t border-foreground/5 bg-[hsl(248_40%_98%/0.5)] dark:bg-[hsl(248_50%_8%/0.5)] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-20 max-w-3xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed font-medium">
              Start for free. Upgrade when you want everything Echo can do with
              you.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-24">
            <motion.div
              className="glass-strong rounded-[2.5rem] p-12 border border-foreground/10 flex flex-col"
              {...fadeUp(0.1)}
            >
              <div className="flex-1">
                ...
                <p className="text-lg text-muted-foreground mb-10 font-medium">
                  The Signal Check, basic audits, and the deterministic photo
                  checklist.
                </p>
                <ul className="space-y-4 mb-10">
                  <li className="flex items-center gap-3 font-medium text-foreground">
                    <CheckSquare className="w-5 h-5 text-[hsl(142_55%_50%)]" />{" "}
                    1 Signal Check per month
                  </li>
                  <li className="flex items-center gap-3 font-medium text-foreground">
                    <CheckSquare className="w-5 h-5 text-[hsl(142_55%_50%)]" />{" "}
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="w-full rounded-full border-foreground/20 font-bold h-14 text-lg"
              >
            ...
            <motion.div
              className="glass-strong rounded-[2.5rem] p-12 border border-[hsl(248_62%_52%/0.5)] shadow-2xl relative flex flex-col glow-violet"
              {...fadeUp(0.2)}
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-5xl font-serif font-bold mb-6">
                  $97{" "}
                  <span className="text-xl text-muted-foreground font-sans font-medium">
                    one-time
                  </span>
                </p>
                <p className="text-lg text-muted-foreground mb-10 font-medium">
                ...
                <ul className="space-y-4 mb-10">
                  <li className="flex items-center gap-3 font-bold text-foreground">
                    <CheckSquare className="w-5 h-5 text-[hsl(248_62%_52%)]" />{" "}
              ...
              <Button
                asChild
                size="lg"
                className="w-full rounded-full bg-[hsl(248_62%_52%)] hover:bg-[hsl(248_62%_52%/0.9)] text-white font-bold h-14 text-lg shadow-lg hover:shadow-xl transition-all"
              >
          ...
          >
            <h3 className="text-3xl font-serif font-bold mb-8">
              Ready to let Echo get to know you?
            </h3>
            <Button
              asChild
              size="lg"
            ...
            >
              <Link href="/today">
                Continue with Echo <ArrowRight className="ml-3 h-6 w-6" />
              </Link>
            </Button>
          </motion.div>
        </div>
