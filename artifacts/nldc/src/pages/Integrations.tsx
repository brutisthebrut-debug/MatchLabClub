...
const CONNECTED: IntegrationCard[] = [
  {
    ...
    privacy:
      "Read only. Never posts. Encrypted at rest. If Deep AI is on in Settings, the import summary can use the named provider under the current handling described in Privacy. Off means a structural summary instead. Delete parsed data from your vault.",
  },
  {
    ...
    privacy:
      "Read only. Pasted text only. No API call to Meta, no login, no follower list. If Deep AI is on, tone extraction can use the named provider under the handling described in Privacy. Off uses the structural extractor.",
  },
  {
    ...
    privacy:
      "Session only by default. Encrypted at rest if you save. Counterparty identifiers are stripped before storage. If Deep AI is on, reply options can use the named provider under the handling described in Privacy. Off uses structural reply options.",
  },
];
