...
function analyzeBlueprint(text: string, pattern: string, misread: string, want: string): BlueprintResult {
  ...
  const comfortNeeds = [
  "You relax when the pressure is off, when there's no agenda, no performance requirement, no 'where is this going.' Casual context (a walk, a shared task, a low-stakes second setting) tends to open you up faster than formal date formats. You show up most fully when you've been given time to feel safe.",
...
const DEMO_RESULT: BlueprintResult = {
  ...
  comfortNeeds: "You relax when the pressure is off, when there's no agenda, no performance requirement, no 'where is this going.' Casual context tends to open you up faster than formal date formats.",
...
export default function Blueprint() {
  ...
  <span className="text-[hsl(43_65%_78%)] font-semibold">Using a backup blueprint.</span>{" "}
  ...
  data-testid="button-retry-blueprint"
  >
