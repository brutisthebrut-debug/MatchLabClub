...
const PRIVACY_PRINCIPLES = [
  ...
  { icon: Trash2, title: "Self-service account deletion", desc: "One action removes MatchLab account content and preferences after any live subscription is safely stopped. Payment processors or law may require limited transaction records to remain.", color: "hsl(var(--brand-gold))" },
