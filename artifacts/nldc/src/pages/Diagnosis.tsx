                ...
                <AnimatePresence mode="wait">
                  ...
                  {step === 1 && (
                    <motion.div key="s1" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="glass border border-white/8 rounded-3xl p-8 space-y-5">
                      ...
                      <div className="space-y-2">
                        <Label className="text-foreground/70 text-xs font-semibold uppercase tracking-wider">A conversation sample <span className="text-muted-foreground font-normal">(optional — unlocks messaging diagnosis)</span></Label>
                        <Textarea
