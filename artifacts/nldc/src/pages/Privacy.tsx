...
export default function Privacy() {
  ...
  <p>Future versions of MatchLab Club may offer optional connections to Gmail, calendar apps, or dating platforms for deeper coaching. These will always be:</p>
