      ...
      <div className="min-h-screen mesh-bg">
        ...
        <div className="container mx-auto px-4 md:px-6 py-20 max-w-4xl relative z-10">
          ...
          <motion.div {...fadeUp(0)} className="mb-14">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass border border-[hsl(248_62%_52%/0.25)] text-xs font-semibold uppercase tracking-widest text-[hsl(248_62%_65%)] mb-6">
          ...
          <motion.div {...fadeUp(0.08)} className="mb-10">
            <Link href={`/blog/${ARTICLES[0]!.slug}`}>
              <div className="glass border border-[hsl(248_62%_52%/0.2)] rounded-3xl p-8 md:p-10 hover:bg-white/3 transition-colors group cursor-pointer">
                ...
                <h2 className="font-serif text-2xl md:text-3xl font-bold text-foreground mb-4 leading-snug group-hover:text-primary transition-colors">
                  {ARTICLES[0]!.title}
                </h2>
                ...
                <div className="flex items-center gap-4 text-xs text-muted-foreground/50">
                  ...
                  <span className="ml-auto text-[hsl(248_62%_62%)] font-semibold flex items-center gap-1 group-hover:gap-2 transition-all">
              ...
              <motion.div key={article.slug} {...fadeUp(0.14 + i * 0.05)}>
                <Link href={`/blog/${article.slug}`}>
                  <div className="glass rounded-2xl p-6 h-full hover:bg-white/3 transition-colors group cursor-pointer flex flex-col"
                    ...
                    <h3 className="font-serif text-base font-bold text-foreground mb-3 leading-snug group-hover:text-primary transition-colors flex-1">
                      {article.title}
                    </h3>
          ...
          <motion.div {...fadeUp(0.35)} className="mt-16 text-center">
            ...
            <Link
              href="/start"
              className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-[#3D35CC] to-[#FF2D9B] text-white font-semibold rounded-xl hover:opacity-90 transition-opacity"
            >
