...
export function Footer() {
  ...
  A second brain for your dating life. It sits on top of the apps you already use, Tinder, Hinge, Bumble, Grindr, Feeld, HER, Facebook Dating, and more, and turns the real signals you already generate into a readiness score, then uses it to introduce you to real people. It never replaces the apps, it makes you better at them.
  </p>
