...
export const DEMO_SIGNAL_MAP: SignalMap = {
  ...
  lanes: [
    ...
    },
    {
      ...
      weightPercent: 5,
      confidence: 50,
      dimensions: ["how full their life is outside dating", "real-world rhythm"],
      hasSignal: false,
      action: {
        label: "Forward a few receipts",
        detail: "Forward order, booking, and ticket emails. We read sender and subject, never the body.",
        href: "/receipts",
      },
    },
    {
