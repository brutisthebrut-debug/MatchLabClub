...
const LOVE_PACE: Quiz = {
  ...
  archetypes: {
    freefaller: {
      ...
      nextStep: "Try a 'one-day delay' before your most enthusiastic reply this week. Not to play games — to see whether the urgency is yours or theirs.",
...
const ENERGY_SOURCES: Quiz = {
  ...
  archetypes: {
    ...
    maker: {
      ...
      nextStep: "Put one specific 'what I'm building' line in your profile this week. Not aspirational — what you're actually doing right now.",
...
const BOUNDARY_BLUEPRINT: Quiz = {
  ...
  archetypes: {
    ...
    retreater: {
      ...
      insight: "Going quiet is a real boundary — it's just an invisible one. Which means the people who deserve to hear from you sometimes don't, and the people who don't deserve your time still get to wonder. The growth edge: one specific sentence at the point of pulling back changes the dynamic completely.",
