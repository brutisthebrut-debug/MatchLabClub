...
export const DIMENSION_META: Record<string, { label: string; color: string; blurb: string }> = {
  ...
  intellectual: { label: "Intellectual",           color: "hsl(268 52% 68%)",  blurb: "Curiosity, learning, and the questions you carry." },
  ...
  boundaries:   { label: "Boundaries",             color: "hsl(285 45% 65%)",  blurb: "What you protect and how you communicate it." },
  ...
  culture:      { label: "Culture & Background",   color: "hsl(268 52% 68%)",  blurb: "Heritage, traditions, and shared context." },
};
