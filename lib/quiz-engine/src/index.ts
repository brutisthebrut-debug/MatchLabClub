/**
 * Canonical Quiz Lab definitions and deterministic scorer shared by the web
 * client and API server. Quiz identity, answer validation, and scoring must
 * never have separate browser/server copies.
 *
