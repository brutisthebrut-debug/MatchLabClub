 ...
 */
export const getMyBilling = async ( options?: RequestInit): Promise<BillingState> => {

  return customFetch<BillingState>(getGetMyBillingUrl(),
  {
    ...options,
    method: 'GET'
...
export const getCreateBillingCheckoutUrl = () => {
  ...
  return `/api/me/billing/checkout`
}
