Warning: truncated output (original token count: 128885)
Total output lines: 16962
...
const {mutation: mutationOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type GenerateAuditReportMutationError = Error…28885 tokens truncated…adjusting the retention window or to
